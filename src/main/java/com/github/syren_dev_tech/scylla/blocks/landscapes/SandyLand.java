...
public class SandyLand {
    ...
    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name) {
        return create(register, name, Properties.ofFullCopy(Blocks.SAND), SAND_DUST_COLOR);
    }

    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name, ResourceKey<CreativeModeTab> creativeTab) {
        return create(register, name, Properties.ofFullCopy(Blocks.SAND), SAND_DUST_COLOR, creativeTab);
    }

    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name, Properties properties) {
        return create(register, name, properties, SAND_DUST_COLOR);
    }

    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name, Properties properties, ResourceKey<CreativeModeTab> creativeTab) {
        return create(register, name, properties, SAND_DUST_COLOR, creativeTab);
    }

    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name, Properties properties, ColorRGBA dustColor) {
        return register.blockRegistry.register(name, BlockDefinition.of(() -> new ColoredFallingBlock(dustColor, properties)));
    }

    public static BlockDefinition<ColoredFallingBlock> create(ModRegister register, String name, Properties properties, ColorRGBA dustColor, ResourceKey<CreativeModeTab> creativeTab) {
