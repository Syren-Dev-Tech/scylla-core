...
public class Candles {
    ...
    public static class CakeCandles {
        ...
        public static BlockDefinition<CandleCakeBlock> create(ModRegister register, String name, BlockDefinition<CandleBlock> standingCandle) {
            return create(register, name, Properties.ofFullCopy(Blocks.CANDLE_CAKE), standingCandle);
        }

        public static BlockDefinition<CandleCakeBlock> create(ModRegister register, String name, BlockDefinition<CandleBlock> standingCandle, ResourceKey<CreativeModeTab> creativeTab) {
            return create(register, name, Properties.ofFullCopy(Blocks.CANDLE_CAKE), standingCandle, creativeTab);
        }

        public static BlockDefinition<CandleCakeBlock> create(ModRegister register, String name, Properties properties, BlockDefinition<CandleBlock> standingCandle) {
        ...
        public static BlockDefinition<CandleCakeBlock> create(ModRegister register, String name, Properties properties, BlockDefinition<CandleBlock> standingCandle, ResourceKey<CreativeModeTab> creativeTab) {
    ...
    public static class PlainCandles {
        ...
        public static BlockDefinition<CandleBlock> create(ModRegister register, String name) {
            return create(register, name, Properties.ofFullCopy(Blocks.FIRE));
        }

        public static BlockDefinition<CandleBlock> create(ModRegister register, String name, ResourceKey<CreativeModeTab> creativeTab) {
            return create(register, name, Properties.ofFullCopy(Blocks.FIRE), creativeTab);
        }

        public static BlockDefinition<CandleBlock> create(ModRegister register, String name, Properties properties) {
            return register.blockRegistry.register(name, BlockDefinition.of(() -> new CandleBlock(properties)));
        }

        public static BlockDefinition<CandleBlock> create(ModRegister register, String name, Properties properties, ResourceKey<CreativeModeTab> creativeTab) {
