...
public class Liquid {
    ...
    public static BlockDefinition<LiquidBlock> create(ModRegister register, String name, FlowingFluid flowingFluid) {
        return create(register, name, Properties.ofFullCopy(Blocks.WATER), flowingFluid);
    }

    public static BlockDefinition<LiquidBlock> create(ModRegister register, String name, Properties properties, FlowingFluid flowingFluid) {
