...
public class Stems {
    ...
    public static class AttachedStems {
        ...
        public static BlockDefinition<AttachedStemBlock> create(ModRegister register, String name, ResourceKey<Block> stem, ResourceKey<Block> fruit, ResourceKey<Item> seed) {
        ...
        public static BlockDefinition<AttachedStemBlock> create(ModRegister register, String name, ResourceKey<Block> stem, ResourceKey<Block> fruit, ResourceKey<Item> seed, Properties properties) {
    ...
    public static class GrowingStems {
        ...
        public static BlockDefinition<StemBlock> create(ModRegister register, String name, ResourceKey<Block> fruit, ResourceKey<Block> attachedStem, ResourceKey<Item> seed) {
        ...
        public static BlockDefinition<StemBlock> create(ModRegister register, String name, ResourceKey<Block> fruit, ResourceKey<Block> attachedStem, ResourceKey<Item> seed, Properties properties) {
